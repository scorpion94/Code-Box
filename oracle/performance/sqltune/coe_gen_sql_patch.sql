...
REM
REM $Header: 215187.1 coe_gen_sql_patch.sql 12.1.02 2013/09/00 stelios.charalambides $
REM
...
declare
  v1 varchar2(32767);
BEGIN
  dbms_output.put_line('&&hint_text.');
  v1:=SYS.DBMS_SQLDIAG.CREATE_SQL_PATCH (
    sql_id      => '&&sql_id.',
    hint_text   => '&&hint_text.',
    name        => 'coe_&&sql_id.',
    category=>'DEFAULT'
